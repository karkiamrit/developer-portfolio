...
const NavBar = () => {
    ...
    return (
        <div className="sticky top-0 flex flex-row z-50 text-white bg-customGray h-16 xl:h-20">
            <div className="absolute xl:left-48 left-12 items-start pt-3 xl:pt-5">
                <Link href="/about">
                <Image src="/images/navigation/logo.png" alt="Logo" width={30} height={30} />
                <h1 className="absolute hover:text-orange-600 bottom-2 left-10 hidden xl:block text-2xl font-serif">mrit</h1>
                </Link>
            </div>
            <div className="xl:flex xl:flex-row xl:w-full xl:justify-center hidden">
            ...
            <div className="xl:hidden flex flex-row justify-end w-full pr-16">
                <DropdownMenu>
            ...
            <div className="absolute right-36 pt-3 xl:pt-5 hidden xl:block">
