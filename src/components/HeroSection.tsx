...
function HeroSection() {
    return (
        ...
        <div className="relative hero h-full flex items-center overflow-hidden xl:overflow-visible justify-center xl:justify-start">
            ...
            <div className="text-center xl:text-start z-10 text-white text-4xl font-bold">
                ...
                <h1 className="text-orange-500 flex flex-col xl:flex-row text-center xl:ml-48 xl:mt-10 font-semibold xl:text-6xl ml-10 text-7xl mt-8">I'm Amrit,</h1>
                <h2 className="text-customGray flex flex-row xl:ml-48 mt-8 text-5xl justify-center xl:justify-start ml-10 ">Full Stack Developer </h2>
                <h2 className="text-customGray flex flex-row xl:ml-48 mt-8 text-5xl xl:justify-start justify-center ml-10">based in Nepal.</h2>
                <p className="flex flex-row xl:ml-48 mt-8 text-base font-medium font-sans text-gray-500 xl:w-4/12 max-w-[450px] xl:max-w-full ml-4"> 
