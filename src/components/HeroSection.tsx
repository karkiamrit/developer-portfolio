    ...
    return (
        ...
        <div className="relative hero h-full flex items-center overflow-hidden xl:overflow-visible">
            ...
            <div className="z-10 text-white text-4xl font-bold">
                ...
                <p className="flex flex-row xl:ml-48 mt-8 text-base font-medium font-sans text-gray-500 xl:w-4/12 w-[500px] ml-8"> 
                ...
                <div className="relative flex xl:flex-row flex-col xl:justify-start items-center text-white">
                    ...
                    <Button size="xl" variant={"outline"} className="float-right xl:ml-10 mt-10 rounded-full border-customGray h-12 text-xl font-sans flex flex-row xl:w-32 w-[265px]">
                        Hire Me
                    </Button>
                </div> 
